...
exports.getAdsAnalytics = exports.recordImpression = void 0;
...
const recordImpression = async (req, res) => {
    ...
    try {
        ...
        await db_1.default.query('INSERT INTO "AdEvent" (id, device_id, time_spent) VALUES ($1, $2, $3)', [id, deviceId, spent]);
...
const getAdsAnalytics = async (req, res) => {
    try {
        ...
        const currentQuery = await db_1.default.query(`
      SELECT 
    ...
    `);
        ...
        const lastMonthQuery = await db_1.default.query(`
      SELECT 
        COUNT(id) AS impressions,
        COUNT(DISTINCT device_id) AS accounts_reached,
        AVG(time_spent) AS atps
    ...
    `);
        ...
        const last7DaysQuery = await db_1.default.query(`
      SELECT 
...
exports.getAdsAnalytics = getAdsAnalytics;
